...
users = data.read_json("filtered_users_0307.json")
omega_steps = data.read_json("user_omega_step_0307.json")
...
f = open("filtered_users_0307_revised.json", 'w')
json.dump(users, f)
f.close()
f = open("user_omega_step_0307_revised.json", 'w')
